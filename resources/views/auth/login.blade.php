                            ...
                            <div class="tab-pane fade" id="pills-profiles" role="tabpanel"
                                ...
                                <div class="wsus__login">
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="wsus__login_input">
                                            <i class="fas fa-key"></i>
                                            <input type="password" placeholder="Password" value="{{old('password')}}" id="password" name="password">
                                        </div>
                                        <div class="wsus__login_input mb-3">
                                            <i class="fas fa-key"></i>
                                            <input type="password" placeholder="Confirm Password" id="password_confirmation" type="password"
