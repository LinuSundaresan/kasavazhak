      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <div>
                <form action="{{ route('admin.coupens.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control datepicker" name="end_date"  value={{ old('start_date') }}>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5">
                      ...
                      <div class="col-md-4">
                        ...
                        <select class="form-control" name="discount_type" >
                            ...
                            <option value="percent">Percantage %</option>
