                ...
                <div class="row">
                  ...
                  <div class="col-10">
                    <div class="tab-content" id="nav-tabContent">
                      @include('admin.payment-settings.sections.paypal-settings')
                      @include('admin.payment-settings.sections.stripe-settings')
                    @include('admin.payment-settings.sections.razorpay-settings')
