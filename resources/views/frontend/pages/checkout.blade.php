                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="wsus__order_details" id="sticky_sidebar">
                            ...
                            <div class="wsus__order_details_summery">
                                ...
                                <p>coupen(-): <span>{{ $settings->currency_icon }} {{ getCartDiscount() }}</span></p>
                                        ...
                                        <div class="wsus__check_single_form">
                                            <select class="select_2" name="country">
                                                @foreach(config('settings.country_list') as $key =>$country)
                                                    <option value="{{ $key }}" {{ $country== old('country') ? 'selected' : '' }}>{{ $country }}</option>
                                                @endforeach
    ...
    <script>
        $('document').ready(function(){
            ...
            $('.shipping_address').on('click', function(){
                let shippingAddress = $(this).data('id');
