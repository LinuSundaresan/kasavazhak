...
class VendorProductVariantItemController extends Controller
{
    public function index(VendorProductVariantItemDataTable $datatable, $productId, $variantId)
    {
        ...
        return $datatable->render('vendor.product.product-variant-item.index' , compact(
            'product',
            'variant'
        ));
    }
    ...
    public function store(ProductVariantItemRequest $request)
    {
        ...
        return redirect()->route('vendor.products-variant-item.index', ['productId'=>$request->product_id, 'variantId'=>$request->product_variant_id]);
    }

    public function edit($variantId)
    {
        $variantData = app(ProductVariantItemRepositoryInterface::class)->getById($variantId);
        return view('vendor.product.product-variant-item.edit', compact('variantData'));
    }
    ...
    public function update(ProductVariantItemUpdateRequest $request , $variantId)
    {
        ...
        return redirect()->route('vendor.products-variant-item.index', ['productId'=>$productId ,'variantId'=>$variantId]);
    }
    ...
    public function updateStatus(ProductVariantItemStatusUpdateRequest $request)
    {
